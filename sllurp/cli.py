...
@click.option('--impinj-search-mode', type=click.Choice(['1', '2']),
              help=('Impinj extension: inventory search mode '
                    ' (1=single, 2=double)'))
@click.option('--impinj-extensions-enable', type=click.Choice(['0','1']),
              help=('Enable Impinj extension of rospec (phase angle, rssi,'
                    ' Doppler) (0=disabled, 1=enabled'))
def inventory(host, port, time, report_every_n_tags, antennas, tx_power,
              ...
              impinj_search_mode, impinj_extensions_enable):
    ...
    Args = namedtuple('Args', ['host', 'port', 'time', 'every_n', 'antennas',
                               ...
                               'reconnect', 'impinj_search_mode', 'impinj_extensions_enable'])
    args = Args(host=host, port=port, time=time, every_n=report_every_n_tags,
                ...
                impinj_extensions_enable=impinj_extensions_enable)
